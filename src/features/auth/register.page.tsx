...
import { User, Mail, MapPin, Lock, Eye, EyeOff, ArrowRight, ArrowLeft } from "lucide-react";
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center px-4 pt-8">
        <div className="w-full max-w-4xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <User className="absolute left-5 top-1/2 size-5 -translate-y-1/2" style={{ color: "#767D4E" }} />
              <input
                type="text"
            ...
            <div className="relative">
              <Mail className="absolute left-5 top-1/2 size-5 -translate-y-1/2" style={{ color: "#767D4E" }} />
              <input
                type="email"
            ...
            <div className="relative">
              <MapPin className="absolute left-5 top-1/2 size-5 -translate-y-1/2" style={{ color: "#767D4E" }} />
              <input
                type="text"
            ...
            <div className="relative">
              <Lock className="absolute left-5 top-1/2 size-5 -translate-y-1/2" style={{ color: "#767D4E" }} />
              <input
