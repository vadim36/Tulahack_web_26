...
function AccountPage() {
    const [posts] = useState(savedPosts);
        ...
        >
            ...
            <div className="relative">
                ...
                <div className="relative mx-auto max-w-[1600px] px-6 pt-6">
                    <div
                        className="relative h-56 md:h-72 rounded-b-[46px] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.15)]">
                        <img
                            src={userData.cover}
                            alt="Cover"
                        ...
                        >
                            <svg viewBox="0 0 24 24" fill="none" stroke="#f5ebda" strokeWidth="2.5" className="w-7 h-7">
                ...
                <div className="relative mx-auto max-w-[1400px] px-10 mt-10">
                    <button
                        className="flex items-center gap-3 px-6 py-3 rounded-full border-[3px] border-olive text-olive text-xl font-serif">
                        Сохраненные
                        <ChevronDown size={22}/>
                    </button>
